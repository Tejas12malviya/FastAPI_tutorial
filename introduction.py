...
@app.get("/user/me")  # When we will call this path operation decorator, the first one will work but lower will not work i.e same path operation decorator do not work. 
def user():
